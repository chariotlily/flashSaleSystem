...
//             $("#flashsale").append(
//                 "<li class='flashsale-item'><div class='pic' ><img src='" + list["img"] + "' alt=''></div><div class='intro'><span>" + list["desc"] + "</span></div>"
...
//                 + "</div>"
//                 + "<div>Remain<b class='owned'>" + list["leaved"] + "</b></div>"
//                 + "</div>"
//                 + "<a class='sui-btn btn-block btn-buy' href='flashsale-item.html' target='_blank'>Buy</a>"
//                 + "</li >"
//             );
